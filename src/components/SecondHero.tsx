    ...
    <div className=' py-12 bg-slate-900'>
        ...
        <div className='mt-10 flex justify-center items-center'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-8 bg-blue-500 dark:bg-zinc-900 shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">        
